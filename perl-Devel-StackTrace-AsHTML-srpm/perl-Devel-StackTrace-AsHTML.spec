...
%changelog
* Wed Mar 13 2013 Nico Kadel-Garcia <nkadelgarfia-consultant@scholastic.com>
- 0.11-0.1
- Rollback release number to avoid update conflicts.
- Add BuildRequireS: perl(Test::Harness).
- Ignore 'make test' failures for mock compilation.
